...
enum ProgramSourceType: String, Codable {
    case seeded = "seeded"         // Pre-built programs from ProgramData
    case userCreated = "user"       // Manually created by user
    case aiGenerated = "ai"         // Generated by AI
    case imported = "imported"      // Imported from file/share
}
...
final class ProgramTemplate {
    ...
    var sourceTypeRaw: String = ProgramSourceType.seeded.rawValue  // Default to seeded

    var sourceType: ProgramSourceType {
        get { ProgramSourceType(rawValue: sourceTypeRaw) ?? .seeded }
        set { sourceTypeRaw = newValue.rawValue }
    }

    var isUserProgram: Bool {
        sourceType == .userCreated || sourceType == .aiGenerated || sourceType == .imported
    }
